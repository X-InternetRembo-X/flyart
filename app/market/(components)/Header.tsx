...
const Header = () => {
  return (
    <div className="h-[60px] px-[150px] bg-pink-600 z-10 fixed xl:absolute top-0 right-0 w-[100%] p-2 flex flex-row gap-2 items-center justify-between  mr-2 md:mr-0 shadow-xl  ">
      <span
        className={`text-caveat font-sans text-white text-[48px] font-bold`}
      >
        FlyArt
      </span>
      <div className={"flex gap-8 text-white items-center"}>
        <button
          className={
            "bg-white h-[40px] w-[200px] font-medium text-[28px] text-slate-800 rounded-2xl"
          }
        >
          Auctions
        </button>
        <button
          className={
            "bg-white h-[40px] w-[200px] font-medium text-[24px] text-slate-800 rounded-2xl"
          }
        >
          Sell a painting
        </button>

...
const LogInForm = () => {
	...
	const [mode , setMde] = useState('LogIn')
	...
	return (
		<form onSubmit={formik.handleSubmit} className={'flex flex-col items-center'}>
			...
			<button className={'mt-5 w-[300px] bg-black h-[50px] rounded-xl text-2xl'} type="submit">Log In</button>

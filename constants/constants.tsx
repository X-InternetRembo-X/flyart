...
const homeShareYourExperienceBlock = {
...
const homeBuyMaterialsAndToolsBlock = {
...
export const HomePageConstants = {
	homeBuyPaintingBlock,
	homeSellYourWorksBlock,
	homeShareYourExperienceBlock,
	homeBuyMaterialsAndToolsBlock,
}